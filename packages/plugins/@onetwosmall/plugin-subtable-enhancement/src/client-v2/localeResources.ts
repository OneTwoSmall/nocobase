...
const zhCN: Record<string, string> = {
  ...
  'Add mapping': '添加映射',
  'Add new': '新增',
  'All rows deleted': '已删除全部行',
  'Are you sure to delete all {{count}} rows?': '确定删除全部 {{count}} 行数据吗？',
  ...
  'Formula example':
    '公式示例：`{{nastnum}} * {{budget_price}}`，用 {{字段名}} 引用列对应的字段；`{{__rowIndex__}}` 为当前行号（第几行，从 1 开始）',
...
const enUS: Record<string, string> = {
  ...
  'Add new': 'Add new',
  'All rows deleted': 'All rows deleted',
  'Are you sure to delete all {{count}} rows?': 'Are you sure to delete all {{count}} rows?',
  ...
  'Enable delete all': 'Enable delete all',
  ...
  'Formula example':
    'Formula example, e.g. `{{nastnum}} * {{budget_price}}`. Use {{field name}} to reference a column field; `{{__rowIndex__}}` is the current row number (1-based).',
